...
class ViewTest(ViewBase):
    ...
    def __init__(self, *args, **kwargs):
        settings.USE_SOFTDELETE_GROUP = kwargs.get(
    ...
    def test_authorization(self):
        ...
        for view_name in [reverse("softdelete.changeset.list"),
            ...
            self.assertTrue(
                (settings.DOMAIN + reverse('auth_login')) in rv['Location'])
...
class GroupViewTest(ViewTest):
    ...
    def __init__(self, *args, **kwargs):
        super(GroupViewTest, self).__init__(
            USE_SOFTDELETE_GROUP=True, *args, **kwargs)
